...
class CustodyRequest(models.Model):
    ...
    def paid_action(self):
        ...
        self.create_account_move(journal, label, debit_account_id, credit_account_id, amount, address_home_id)
        self.state = 'paid'
    ...
    def liquidated_action(self):
        ...
        debit_account_id = self.env.user.company_id.credit_account_id.id
        amount = self.amount
        address_home_id = self.employee_id.address_home_id.id
        self.create_account_move(journal, label, debit_account_id, credit_account_id, amount, address_home_id)
        self.state = 'done'

...
class HrEmployee(models.Model):
    ...
    def _personal_document_count(self):
        for each in self:
            document_ids = self.env['hr.employee.document'].sudo().search([('employee_ref', '=', each.id)])
            each.personal_document_count = len(document_ids)
    ...
    personal_document_count = fields.Integer(compute='_personal_document_count', string='# Documents')
